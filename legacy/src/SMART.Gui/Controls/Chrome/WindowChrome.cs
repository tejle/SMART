...
namespace System.Windows.Extensions
{
    ...
    public class WindowChrome : DependencyObject
    {
        ...
        private void _SetWindow(Window window)
        {
            ...
            var resourceLocater = new Uri("/" + Assembly.GetExecutingAssembly().GetName().Name + ";component/Controls/Chrome/ChromelessWindowTemplate.xaml", System.UriKind.Relative);
